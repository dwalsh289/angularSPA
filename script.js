...
angularApp.controller('aboutController', function($scope) {
    ...
    $scope.setMessage = function(input) {
        return $scope.currentIndex === 6 ? $scope.message = 'Thanks for looking at my photography!' :     $scope.message = 'A passion of mine is photography. Explore some of the shots from my year living abroad in Japan below.';
    };
